...
import { Search, Filter, ArrowUpDown, X, Calendar, AlertTriangle } from 'lucide-react';
    ...
    <div className="bg-white border border-slate-200/80 rounded-2xl p-4 shadow-xs mb-6 space-y-3">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <label className="text-xs font-semibold text-slate-500 hidden md:inline-block">Sort by:</label>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-100">
        ...
        <div className="flex flex-wrap items-center gap-1.5 text-xs font-medium">
          ...
          <button
            onClick={() => onPriorityFilterChange(priorityFilter === 'overdue' ? 'all' : 'overdue')}
            className={`px-2.5 py-1 rounded-lg border transition-all cursor-pointer flex items-center gap-1 ${
